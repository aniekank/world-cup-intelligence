...
| **Jan 2027 (decide ~Thanksgiving)** | **NFL playoffs product** | HIS CALL (2026-07-16): NFL is a STANDALONE product with its own repo/identity — NOT a third chassis on these bones. Greenfield is the point: design around nflverse play-by-play (EPA, win probability, drive-level) rather than match-forecast shapes; the only WCI assets that travel are the untransferable-by-code ones (trust product: published calibration, receipts culture, honest-data ethos) plus lessons, not modules. Timing: a Week 1 2026 launch was rejected — greenfield needs 6-10 weeks and Q3 is owned (club app beats, Fraud Guard, job hunt). Window 1: Dec 2026 build → January playoffs launch (small scope, peak US attention, club winter lull, market test). Window 2: summer 2027 build → Week 1 2027 full product (collides with the Women's WC slot — choose). Relationship to the bettor vision: decide then whether the NFL product seeds it or stays pure analytics. |
